...
export class TechnischeCompetentieGebruikerController {
  constructor(private readonly technischeCompetentieGebruikerService: TechnischeCompetentieGebruikerService) {}

  @Post()
  create(@Body() createTechnischeCompetentieGebruikerDto: CreateTechnischeCompetentieGebruikerDto) {
    return this.technischeCompetentieGebruikerService.create(createTechnischeCompetentieGebruikerDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateTechnischeCompetentieGebruikerDto: UpdateTechnischeCompetentieGebruikerDto) {
    return this.technischeCompetentieGebruikerService.update(+id, updateTechnischeCompetentieGebruikerDto);
  }
