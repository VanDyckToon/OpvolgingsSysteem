          ...
          >
            ...
            <div class="flex space-x-4">
              ...
              <img
                ...
                @click="
                  openDeleteModal(materiaal.materiaalID, materiaal.beschrijving)
                "
              />
            </div>
          </li>
    ...
    >
      <div class="bg-white p-6 rounded-lg shadow-lg w-1/3">
        ...
        <div class="flex justify-end space-x-4">
          ...
          <button
            @click="
              updateMateriaal(selectedMateriaalID, editedBeschrijving),
                closeModal()
            "
  ...
  methods: {
    ...
    async deleteMateriaal(materiaalID: number) {
      try {
        ...
        console.error(
          'Er is een fout opgetreden bij het verwijderen van het materiaal:',
          error,
        )
      }
    },
